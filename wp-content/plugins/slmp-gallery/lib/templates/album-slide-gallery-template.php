...
function album_slide_gallery_layout() {
...
?>
	<?php if ( $gal_type == 'album_slide' ): ?>
		<div class="slmp-gallery slmp-album-slide-gallery slmp-relative" gallery-id="<?php echo $gal_id ?>" gallery-type="<?php echo $gal_type ?>">
			...
			<?php endif ?>
			<?php if ( $gal_details['album_slide_gallery'] ): ?>
				<div class="slmp-row slmp-album-slide-image-items slmp-relative" data-dots="<?php echo $dots  ?>" data-infinite="<?php echo $infinite ?>" data-fade="<?php echo $fade ?>" data-pause="<?php echo $pause ?>" data-autoplay="<?php echo $auto ?>" data-adaptive="<?php echo $adaptive ?>" data-center="<?php echo $center ?>" data-slides-show="<?php echo $slidesToShow ?>" data-slides-scroll="<?php echo $slidesToScroll ?>" data-speed="<?php echo $speed ?>" data-autoplay-speed="<?php echo $autoplaySpeed ?>" data-first-breakpoint="<?php echo $fisrt_breakpoint ?>" data-first-show="<?php echo $fisrt_slidesToShow ?>" data-first-scroll="<?php echo $fisrt_slidesToScroll ?>" data-second-breakpoint="<?php echo $second_breakpoint ?>"  data-second-show="<?php echo $second_slidesToShow ?>" data-second-scroll="<?php echo $second_slidesToScroll ?>" data-third-breakpoint="<?php echo $third_breakpoint ?>" data-third-show="<?php echo $third_slidesToShow ?>" data-third-scroll="<?php echo $third_slidesToScroll ?>">
					<div class="slmp-display-image slmp-album-slide-display-image slmp-relative">
						<?php foreach ( $gal_details['album_slide_gallery'] as $key => $album_detail ) :
							$al_title 			= $album_detail['album_slide_title'];
							$al_description 	= $album_detail['album_slide_description'];
							$al_thumb 			= $album_detail['album_slide_featured'];
						...
						?>
							<div class="slmp-image-item <?php echo ( $show_zoom ? 'zoom-icon-hover' : 'no-zoom-icon' ) ?> slmp-text-center slmp-relative" data-id="slmp-<?php echo $gal_type ?>-item-<?php echo $al_thumb['id'] ?>-<?php echo $gal_id ?>">
								<div class="slmp-image slmp-relative" data-key="<?php echo $key ?>">
