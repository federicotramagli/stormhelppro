...
function ampforwp_sticky_social_icons(){
	...
	if( (ampforwp_get_setting('enable-single-social-icons') == true && is_single()) || (is_page() && true == $redux_builder_amp['ampforwp-page-sticky-social']))  { 
	    ...
	    $data_param_data = str_replace('@', '', $data_param_data);?>
	        ...
	        <?php } ?>
		  	<?php if($redux_builder_amp['enable-single-whatsapp-group-share'] == true)  { ?>
			<a title="whatsapp group" <?php ampforwp_rel_attributes_social_links(); ?> href="<?php echo esc_url($redux_builder_amp['whatsapp-group-link'])?>">
			<div class="a-so-i">
			    <amp-img src="data:image/svg+xml;utf8;base64," width="50" height="20" alt="whatsapp" />
			    </div>
				</a>
